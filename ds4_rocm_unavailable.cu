...
ROCM_UNAVAILABLE_INT(ds4_gpu_glm53_embedding_bf16)
ROCM_UNAVAILABLE_INT(ds4_gpu_glm53_expand_pool_selection_tensor)
ROCM_UNAVAILABLE_INT(ds4_gpu_glm53_indexer_pool_update_tensor)
ROCM_UNAVAILABLE_INT(ds4_gpu_glm53_indexer_scores_batch_tensor)
ROCM_UNAVAILABLE_INT(ds4_gpu_glm53_kda_decode)
ROCM_UNAVAILABLE_INT(ds4_gpu_glm53_kda_prefill)
ROCM_UNAVAILABLE_INT(ds4_gpu_glm53_matmul_bf16)
